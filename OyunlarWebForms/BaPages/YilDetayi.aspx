<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="YilDetayi.aspx.cs" Inherits="OyunlarWebForms.BaModels.TurDetayi" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <p>
        <br />
        <asp:Label ID="Label1" runat="server" BorderStyle="Solid" BorderWidth="1px" Text="Yil Detayi"></asp:Label>
        </p>
    <p>
        &nbsp;</p>
    <p>
